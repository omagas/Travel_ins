...
<html>
    ...
    <body>
        ...
        <div style="float:left;width:865px;border: 0" id="content">
            <ul id="tab-ul" style="margin-top: 0">
                <li><a href="#tab-input"><s:text name="label.input.step"/></a></li>
                <li><a href="#tab-query"><s:text name="label.input.simple"/></a></li>
            </ul>
