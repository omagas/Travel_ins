    ...
    <body>
        <div class="infoTextContRight">
            ...
            <div class="tabContLeft">
                ...
                <div id="advancedSearchTabStart" class="tabInActiveEndLeft"></div>
                <div id="advancedSearchTabText" class="tabInActiveTextLeft"><a href="invite_broker" class="topnav"><s:text name="要保"/></a></div>
                <div id="advancedSearchTabEnd" class="tabInActiveStartLeft"></div>
                <div id="simpleSearchTabStart" class="tabActiveEndLeft"></div>
                <div id="simpleSearchTabText" class="tabActiveTextLeft"><s:text name="查詢"/></div>
                <div id="simpleSearchTabEnd" class="tabActiveStartLeft"></div>
            </div>
        </div>         
        ...
        <table width="95%" border="0" cellpadding="4" cellspacing="0" class="table" summary="" >
            <thead>
                <tr>
                    <th class="tableHeaderQueryLeft" colspan="5"><div align="left"><FONT color="#ff0000">&nbsp;*</FONT>日期區間請擇一填寫，非日期區間欄位至少搭配一種作為查詢條件。</div></th>
